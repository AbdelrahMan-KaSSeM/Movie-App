...
public class TrailerAdapter extends RecyclerView.Adapter<TrailerAdapter.TrailerViewHolder> {
    ...
    private List<TrailerClass> iTrailerList;
    final private ListItemClickListener iOnClickListener;
    ...
    public int getItemCount() {
        return iTrailerList == null ? 0 : iTrailerList.size();
    }

    public void setTrailerData(List<TrailerClass> trailerItemList) {
        iTrailerList = trailerItemList;
    ...
    public class TrailerViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public void onClick(View view) {
            ...
            iOnClickListener.OnListItemClick(iTrailerList.get(clickedPosition));
        }

        public void bind(int position) {
            listTrailerItemView.setText(iTrailerList.get(position).getName());
        }
    }
}
